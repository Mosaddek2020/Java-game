 ...
 * @author
*/
public class Formate2 extends Application {
  ...
  //-------------------------------------------------------------------------------------------------- 
    ...
    public Formate2(Stage ss,String p1,String p2,int colno,int rowno,boolean b) throws Exception
    {   
        Forcon=b;
        stage =ss;
        Name1 = p1;
            ...
            if(ih==Row-1){
                ...
                if( !rectv[ih-1][jh].getFill().equals(Color.BEIGE) && !recth[ih-1][jh].getFill().equals(Color.BEIGE) && !rectv[ih-1][jh+1].getFill().equals(Color.BEIGE)){
                    ...
                    if( control==1){
                       ...
                       score1+=Integer.parseInt(point[ih-1][jh].getText());
                    }
                    else
                        score2+=Integer.parseInt(point[ih-1][jh].getText());
                ...
                if(!rectv[ih][jh].getFill().equals(Color.BEIGE) && !recth[ih+1][jh].getFill().equals(Color.BEIGE) && !rectv[ih][jh+1].getFill().equals(Color.BEIGE)){
                    makeBox("X",ih,jh);
                      if( control==1)
                        score1+=Integer.parseInt(point[ih][jh].getText());
                    else
                        score2+=Integer.parseInt(point[ih][jh].getText());
